...
namespace sict {
	...
	Fraction Fraction::operator * (const Fraction& rhs) const {
		Fraction result;
		if (!isEmpty() && !rhs.isEmpty()) {
			result.f_numerator = f_numerator * rhs.f_numerator;
			result.f_denominator = f_denominator * rhs.f_denominator;
			result.reduce();
		}
		return result;
	...
	bool Fraction::operator == (const Fraction& rhs) const {
		...
		else if (!isEmpty() && !rhs.isEmpty() && f_numerator == rhs.f_numerator && f_denominator == rhs.f_denominator)
			return true;
		else
			return false;
	}
